                            ...
                            <div className="p-20">
                                <div className="row">
                                    <div className="basic-info col-md-12">
                                        ...
                                        {/*TODO: Stripe limits interval count to be 2 years <Inputs type="number" name="interval_count" label="Interval Count" defaultValue={paymentPlan.interval_count} onChange={function(){}} receiveOnChange={true} receiveValue={true}/> </div> </div> </div> <div id="request-submission-box" className="modal-footer text-right"> <Buttons containerClass="inline" btnType="primary" text="Submit" type="submit" value="submit"/> <Buttons containerClass="inline" btnType="default" text="Close" onClick={this.props.onHide}/> </div> </DataForm> </div> ); }else{ return( <div> <div className="p-20"> <p><strong>You do not have a payment plan setup.</strong></p> </div> <div id="request-submission-box" className="modal-footer text-right"> <Buttons btnType="default" text="Close" onClick={this.props.onHide}/> </div> </div> ); } } } } export default ServiceInstanceFormEdit; id:95                                         <Inputs type="number" name="interval_count" label="Interval Count" defaultValue={paymentPlan.interval_count}                                                 onChange={function(){}} receiveOnChange={true} receiveValue={true}/>                                     </div>                                 </div>                             </div>                             <div id="request-submission-box" className="modal-footer text-right">                                 <Buttons containerClass="inline" btnType="primary" text="Submit" type="submit" value="submit"/>                                 <Buttons containerClass="inline" btnType="default" text="Close" onClick={this.props.onHide}/>                             </div>                         </DataForm>                     </div>                 );             }else{                 return( <div>                             <div className="p-20">                                <p><strong>You do not have a payment plan setup.</strong></p>                             </div>                             <div id="request-submission-box" className="modal-footer text-right">                                 <Buttons btnType="default" text="Close" onClick={this.props.onHide}/>                             </div>                         </div>                 );             }         }     } } export default ServiceInstanceFormEdit; */}
