            ...
            <div>
                <DataForm validators={this.getValidators(null)} handleResponse={this.handleResponse} url={`${self.state.url}`} method={'POST'}>
                    <div className="m-b-20">
                        ...
                        {/*TODO: Reset Inputs after submission <Inputs type="textarea" name="message" defaultValue="" rows="4" label="Leave your comments or questions and we will respond as soon as we can!" onChange={function(){}} receiveOnChange={true} receiveValue={true}/> </div> <div className="text-right"> <Buttons btnType="primary" text="Comment" onClick={this.handleSubmit} type="submit" value="submit" loading={this.state.ajaxLoad}/> </div> </DataForm> </div> ); } } export default ServiceInstanceMessageForm; id:56                         <Inputs type="textarea" name="message" defaultValue="" rows="4"                                 label="Leave your comments or questions and we will respond as soon as we can!"                                 onChange={function(){}} receiveOnChange={true} receiveValue={true}/>                     </div>                     <div className="text-right">                         <Buttons btnType="primary" text="Comment" onClick={this.handleSubmit}                                  type="submit" value="submit" loading={this.state.ajaxLoad}/>                     </div>                 </DataForm>             </div>         );     } } export default ServiceInstanceMessageForm; */}
